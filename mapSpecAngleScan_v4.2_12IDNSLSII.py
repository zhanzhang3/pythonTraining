...
Script to process a dataset using the Sector12NSLSIISpecDataSource
...
Change list:
    ...
    2024/04/04 (ZZ):
       - calling the routine Sector12NSLSIISpecDataSource instead of Sector33SpecDataSource
            to handle the file/folder structure Hua Zhou generated at NSLSII 4ID.  
            It's slightly different from the old Sector12SpecDataSource. 
...
from rsMap3D.datasource.Sector12NSLSIISpecDataSource import Sector12NSLSIISpecDataSource
...
for idx, dataset in enumerate(datasets, 1):
    ...
    for scanList1 in scanListTop:
        ...
        ds = Sector12NSLSIISpecDataSource(projectDir, specName, specExt,
